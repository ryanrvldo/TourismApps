...
import com.ryanrvldo.tourismapp.core.data.source.remote.network.TourismApiConfig
...
object Injection {
    ...
    private fun provideRepository(context: Context): TourismRepository {
        ...
        val remoteDataSource = RemoteDataSource.getInstance(TourismApiConfig.provideApiService())
